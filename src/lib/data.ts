...
export const channels: Channel[] = [
  { id: 'ch-1', name: 'WhatsApp Support', type: 'WhatsApp', status: 'online', lastActivity: '5 minutes ago', autoReply: true, agentId: 'agent-1' },
  { id: 'ch-2', name: 'Website Chat', type: 'Widget', status: 'offline', lastActivity: '2 hours ago', autoReply: false },
  { id: 'ch-3', name: 'WeChat Marketing', type: 'WeChat', status: 'error', lastActivity: '1 day ago', autoReply: true, agentId: 'agent-2' },
